...
public class EBEConfigScreen extends SpruceScreen {
    ...
    private boolean hadShiftDown = false;
    ...
    protected void init() {
        ...
        this.addDrawableChild(new SpruceButtonWidget(Position.of(bottomCenter - 104, this.height - 27), 100, 20, ScreenTexts.CANCEL, button -> this.onClose()));
